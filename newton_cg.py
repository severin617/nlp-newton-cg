...
class EHNewtonOptimizer(optimizer_v2.OptimizerV2):
  ...
  """
    ...
    """
        ...
        print("From constructor: ", learning_rate)
    ...
    def _prepare_local(self, var_device, var_dtype, apply_state):
        ...
        print("From _prepare_local: ", lr_t)
    ...
    def _resource_compute_dense(self, grad, var, apply_state=None):
        ...
        print("eso._resource_compute_dense() FINISHED. Learning rate updated: ", eval(coefficients['lr_t']))
        return scaled_step
    ...
    def _resource_compute_sparse(self, grad, var, apply_state=None):
        ...
        step = self._newton_step(grad, var, coefficients)
        scaled_step = math_ops.multiply(step, coefficients['lr_t'])
        print("eso._resource_compute_sparse() FINISHED. Learning rate updated: ", eval(coefficients['lr_t']))
        return scaled_step
    ...
    *NOTE*: `Multiply` supports broadcasting. More about broadcasting
    ...
    """
        ...
        print("Hello from newton step")
        print("LR:", eval(coefficients['lr_t']))
